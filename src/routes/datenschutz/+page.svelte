...
// Parts of this file were generated by another service. See the info at the bottom.
// Teile dieser Datei wurden von einem anderen Dienst generiert. Siehe die Informationen am Ende.
-->
...
<svelte:head>
    <title>Datenschutz | Dyn. Kepler-App-Daten</title>
</svelte:head>

<div class="card shadow-lg m-4 w-fit">
    <div class="card-body">
        <h2 class="text-lg font-bold">Datenschutzerklärung</h2>
        <p>
            <a href="/" class="link">Zurück</a>
        </p>
<div id='generator_results'>
<div id='generator_results_content'>
<h1 class="font-bold">Datenschutzhinweise</h1>
<h2 class="font-bold">Verantwortlicher</h2>
...
<h2 class="font-bold">Ihre Betroffenenrechte</h2>
...
<h2 class="font-bold">Verarbeitungstätigkeiten</h2>
<h3 class="font-bold">Kommentarfunktion</h3>
<h4 class="font-bold">Art und Zweck der Verarbeitung</h4>
<p>Wenn Nutzer Kommentare auf unserer Website hinterlassen, speichern wir zusätzlich zu den Daten im Eingabeformular auch noch den Zeitpunkt der Eingabe sowie die IP-Adresse von dem Gerät, mit dem der Kommentar hinterlassen wurde.</p>
<p>Dies dient unserer Sicherheit, da wir für widerrechtliche Inhalte auf unserer Webseite belangt werden können, auch wenn diese durch Benutzer erstellt wurden.</p>
<h4 class="font-bold">Rechtsgrundlage und berechtigtes Interesse</h4>
...
<h4 class="font-bold">Empfänger</h4>
<p>Empfänger der Daten sind ggf. technische Dienstleister, die für den Betrieb und die Wartung unserer Webseite als Auftragsverarbeiter tätig werden.</p>
<h4 class="font-bold">Speicherdauer</h4>
...
<p>Außerdem können Sie Ihren Kommentar jederzeit durch uns löschen lassen. Schreiben Sie dafür bitte eine E-Mail an den in dieser Datenschutzerklärung aufgeführten Kontaktinformationen und übermitteln den Link zu Ihrem Kommentar sowie zu Identifikationszwecken die bei der Erstellung des Kommentars verwendete E-Mail-Adresse.</p>
<h4 class="font-bold">Bereitstellung vorgeschrieben oder erforderlich</h4>
<p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig. Wir können Ihren Kommentar jedoch nur veröffentlichen, sofern Sie uns die als Pflichtangaben gekennzeichnet Informationen zur Verfügung stellen.</p>
<h4 class="font-bold">Widerspruch</h4>
<p>Lesen Sie dazu die Informationen über Ihr Widerspruchsrecht nach Art. 21 DSGVO weiter unten.</p>
<h2 class="font-bold">Information über Ihr Widerspruchsrecht nach Art. 21 DSGVO</h2>
<h3 class="font-bold">Einzelfallbezogenes Widerspruchsrecht</h3>
...
<h3 class="font-bold">Empfänger eines Widerspruchs</h3>
<p class='generator_user_input'>{@html PUBLIC_RESPONSIBLE_FOR_WEBSITE_HTML}</p>
<h2 class="font-bold">Änderung unserer Datenschutzerklärung</h2>
<p>Wir behalten uns vor, diese Datenschutzerklärung anzupassen, damit sie stets den aktuellen rechtlichen Anforderungen entspricht oder um Änderungen unserer Leistungen in der Datenschutzerklärung umzusetzen, z.B. bei der Einführung neuer Services. Für Ihren erneuten Besuch gilt dann die neue Datenschutzerklärung.</p>
<h2 class="font-bold">Fragen zum Datenschutz</h2>
<p>Wenn Sie Fragen zum Datenschutz haben, schreiben Sie uns bitte eine E-Mail an den oben genannten Verantwortlichen.</p>
<h2 class="font-bold">Urheberrechtliche Hinweise</h2>
